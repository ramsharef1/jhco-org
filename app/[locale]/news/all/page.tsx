      ...
      <section style={{
        ...
        <div style={{ maxWidth: '1500px', margin: '0 auto' }}>
          ...
          <p style={{ fontSize: '18px', color: '#d4af37', margin: 0, maxWidth: '600px' }}>
            {ar ? 'استكشف جميع مبادراتنا وقصصنا الإنسانية المحفوظة بعناية' : 'Explore all our initiatives and humanitarian stories carefully preserved'}
          </p>
        </div>
      </section>
      ...
      <section style={{ padding: '64px 32px', backgroundColor: '#fafaf8', direction: ar ? 'rtl' : 'ltr' }}>
        <div style={{ maxWidth: '1500px', margin: '0 auto' }}>
          ...
          <div style={{ marginBottom: '48px' }}>
            <input
              type="text"
              placeholder={ar ? 'ابحث عن أخبار...' : 'Search news...'}
              value={searchQuery}
              onChange={(e) => {
          ...
          {paginatedArticles.length > 0 ? (
            ...
            <div style={{ textAlign: 'center', padding: '80px 32px' }}>
              <p style={{ fontSize: '18px', color: '#6b6b6b' }}>
                {ar ? 'لا توجد أخبار تطابق معايير البحث الخاصة بك' : 'No articles match your search criteria'}
              </p>
            </div>
          )}
        </div>
