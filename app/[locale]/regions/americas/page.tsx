...
export default function AmericasPage({
  ...
  const region = regions.find(r => r.slug === 'americas')!;
  const regionCountries = countries.filter(c => c.region === 'americas');
      ...
      <section style={{ backgroundColor: '#0a1428', padding: '64px 32px', textAlign: 'center', color: 'white' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <p style={{ fontSize: '18px', marginBottom: '32px', color: '#d4af37', maxWidth: '600px', margin: '0 auto 32px' }}>
            {ar ? 'تبرعك سيحدث فرقاً حقيقياً في حياة الآلاف عبر الأمريكتان' : 'Your donation will make a real difference in the lives of thousands across the Americas'}
          </p>
