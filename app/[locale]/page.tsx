    ...
    <>
        ...
        <div style={{ maxWidth: '1500px', margin: '0 auto' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '60px', alignItems: 'center' }}>
            <div>
              ...
              <h1 style={{ fontSize: '72px', fontWeight: '400', lineHeight: '1.15', color: '#0a1428', marginBottom: '32px', fontFamily: 'Georgia, serif' }}>
                {dict.hero.title}
              </h1>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '48px', borderTop: '1px solid #e8e4db', paddingTop: '40px', maxWidth: '400px' }}>
                <div>
                  <p style={{ fontSize: '32px', color: '#0a1428', fontWeight: '400', fontFamily: 'Georgia, serif', marginBottom: '8px' }}>30+</p>
                ...
                <div>
                  <p style={{ fontSize: '32px', color: '#0a1428', fontWeight: '400', fontFamily: 'Georgia, serif', marginBottom: '8px' }}>75k+</p>
                ...
                <div>
                  <p style={{ fontSize: '32px', color: '#0a1428', fontWeight: '400', fontFamily: 'Georgia, serif', marginBottom: '8px' }}>2.5k+</p>
      ...
      <section style={{ backgroundColor: '#0a1428', padding: '48px 32px', textAlign: 'center', borderBottom: '1px solid rgba(212,175,55,0.2)' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <p style={{ color: 'white', fontSize: '20px', lineHeight: '1.8', fontFamily: 'Georgia, serif' }}>{dict.patronage.statement}</p>
        </div>
      </section>
      ...
      <section style={{ background: 'linear-gradient(180deg, #0a1428, #142850)', padding: '96px 32px', position: 'relative' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '80px' }}>
            ...
            <h2 style={{ fontSize: '48px', fontWeight: '400', color: 'white', marginBottom: '24px', fontFamily: 'Georgia, serif' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '24px' }}>
            {impactStats.map((stat, idx) => (
              <div key={idx} style={{ backgroundColor: 'rgba(255,255,255,0.05)', border: '1px solid rgba(212,175,55,0.3)', padding: '32px', borderRadius: '8px', textAlign: 'center', transition: 'all 0.3s' }}>
                ...
                <p style={{ fontSize: '36px', color: '#d4af37', marginBottom: '8px', fontFamily: 'Georgia, serif', fontWeight: '400' }} dir="ltr">{stat.value}</p>
      ...
      <section style={{ backgroundColor: 'white', padding: '96px 32px' }}>
        <div style={{ maxWidth: '1500px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '80px' }}>
            ...
            <h2 style={{ fontSize: '48px', fontWeight: '400', color: '#0a1428', marginBottom: '24px', fontFamily: 'Georgia, serif' }}>
