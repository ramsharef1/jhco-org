  ...
  return (
    <>
      ...
      <CtaSection
        ...
        subheadline={ar ? 'من خلال شبكتنا المتسعة من الشركاء والمتطوعين، نصل إلى أكثر الفئات ضعفاً في العالم' : 'Through our expanding network of partners and volunteers, we reach the most vulnerable populations worldwide'}
        options={[
          {
