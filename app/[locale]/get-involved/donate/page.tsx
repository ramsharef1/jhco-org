...
export default async function DonatePage({
  ...
  const impactLevels = [
    { amount: 10, impact: ar ? '5 وجبات' : '5 Meals', icon: '🍽️', color: '#ff6b6b' },
    { amount: 25, impact: ar ? 'فحص طبي واحد' : '1 Medical Checkup', icon: '🏥', color: '#1abc9c' },
    { amount: 50, impact: ar ? 'كتاب مدرسي واحد' : '1 Textbook', icon: '📚', color: '#e8b923' },
    { amount: 100, impact: ar ? 'تدريب على سبل العيش لشهر' : '1 Month Livelihood Training', icon: '💼', color: '#3498db' },
    { amount: 500, impact: ar ? 'استجابة طوارئ لعائلة واحدة' : '1 Family Emergency Response', icon: '❤️', color: '#e74c3c' },
  ];

  // Donation tier colors
  const donationTiers = [
    { name: ar ? 'برونزي' : 'Bronze', amount: 10, color: '#ff6b6b', bgColor: '#ffe6e6', borderColor: '#ff6b6b', icon: '🥉' },
    { name: ar ? 'فضي' : 'Silver', amount: 25, color: '#1abc9c', bgColor: '#e0f7f4', borderColor: '#1abc9c', icon: '🥈' },
    { name: ar ? 'ذهبي' : 'Gold', amount: 50, color: '#e8b923', bgColor: '#fff9e6', borderColor: '#e8b923', icon: '🏆' },
    { name: ar ? 'بلاتيني' : 'Platinum', amount: 100, color: '#3498db', bgColor: '#e6f2ff', borderColor: '#3498db', icon: '💎' },
    { name: ar ? 'ملكي' : 'Royal', amount: 500, color: '#cb4335', bgColor: '#ffe6e6', borderColor: '#cb4335', icon: '👑' },
  ];
  ...
  return (
    <>
      ...
      {/* IMPACT CALCULATOR - Interactive & Engaging */}
      <section style={{
        padding: '80px 32px',
      ...
      {/* DONOR TESTIMONIALS - Trust Building */}
      <section style={{
        padding: '80px 32px',
      ...
      <section style={{
        padding: '80px 32px',
        backgroundColor: 'linear-gradient(135deg, #e74c3c 0%, #e8b923 100%)',
        color: 'white'
      }}>
