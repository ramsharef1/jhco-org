...
export default function EmotionalButton({
  ...
  const variantStyles = {
    primary: {
      bg: royalColors.warmGold,
      text: royalColors.deepNavy,
      hover: royalColors.goldLight,
      active: royalColors.goldDark,
      shadow: shadows.md,
      border: 'none',
    },
    compassion: {
      bg: royalColors.compassionRed,
      text: '#ffffff',
      hover: royalColors.redLight,
      active: royalColors.redDark,
      shadow: shadows.md,
      border: 'none',
    },
    hopeful: {
      bg: royalColors.hopeTeal,
      text: '#ffffff',
      hover: royalColors.tealLight,
      active: royalColors.tealDark,
      shadow: shadows.md,
      border: 'none',
    },
    secondary: {
      bg: 'transparent',
      text: royalColors.deepNavy,
      hover: royalColors.warmBeige,
      active: royalColors.border,
      shadow: 'none',
      border: `2px solid ${royalColors.softGray}`,
    },
  };
